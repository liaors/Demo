...
import com.rs.demo.basemvp.widght.EuclidListAdapter;
import com.rs.demo.basemvp.widght.EuclidState;
...
public abstract class EuclidActivity extends Activity {
    ...
    private com.nhaarman.listviewanimations.appearance.ViewAnimator mListViewAnimator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acrivity_euclid);
     ...
     */
    private android.animation.Animator getAvatarShowAnimator(int profileDetailsAnimationDelay) {
        final android.animation.Animator mAvatarShowAnimator = android.animation.ObjectAnimator.ofFloat(mOverlayListItemView, View.Y, mOverlayListItemView.getTop(), mToolbarProfile.getBottom());
    ...
    private AnimatorSet getOpenProfileAnimatorSet(int profileDetailsAnimationDelay) {
        if (mOpenProfileAnimatorSet == null) {
            List<android.animation.Animator> profileAnimators = new ArrayList<>();
     ...
     */
    private android.animation.Animator getOpenProfileToolbarAnimator() {
        android.animation.Animator mOpenProfileToolbarAnimator = android.animation.ObjectAnimator.ofFloat(mToolbarProfile, View.Y, -mToolbarProfile.getHeight(), 0);
        mOpenProfileToolbarAnimator.addListener(new android.animation.Animator.AnimatorListener() {
            @Override
     ...
     * @return - animator object.
     */
    private android.animation.Animator getOpenProfileDetailsAnimator() {
        android.animation.Animator mOpenProfileDetailsAnimator = android.animation.ObjectAnimator.ofFloat(mProfileDetails, View.Y,
    ...
    private AnimatorSet getCloseProfileAnimatorSet() {
        if (mCloseProfileAnimatorSet == null) {
            android.animation.Animator profileToolbarAnimator = android.animation.ObjectAnimator.ofFloat(mToolbarProfile, View.X,
                    0, mToolbarProfile.getWidth());

            android.animation.Animator profilePhotoAnimator = android.animation.ObjectAnimator.ofFloat(mOverlayListItemView, View.X,
                    0, mOverlayListItemView.getWidth());
            profilePhotoAnimator.setStartDelay(getStepDelayHideDetailsAnimation());

            android.animation.Animator profileButtonAnimator = android.animation.ObjectAnimator.ofFloat(mButtonProfile, View.X,
            ...
            android.animation.Animator profileDetailsAnimator = android.animation.ObjectAnimator.ofFloat(mProfileDetails, View.X,
                    0, mToolbarProfile.getWidth());
            ...
            mCloseProfileAnimatorSet.addListener(new  android.animation.Animator.AnimatorListener() {
